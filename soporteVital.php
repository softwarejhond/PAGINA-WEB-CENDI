...
<body>
		...
		<div class="container">
			...
			<ul class="main-menu">
				...
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item active" href="soporteVital.html">Primeros Auxilios - Soporte vital básico</a>
	...
	<div class="site-breadcrumb">
		<div class="container">
			...
			<span>Primeros auxilios - Soporte vital básico</span>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 post-list">
					<div class="post-item">
                        <h4>Primeros auxilios - Soporte vital básico</h4>
                        <br>
                        <div class="post-thumb set-bg" data-setbg="img/sliders/primerosAuxilios.jpg"></div>
                        <br>
                            ...
                            <div class="row">
                                <div class="col-lg-12 about-text">
                                    <div class="row">
                                        <div class="col-4">
                                            <img src="img/sliders/auxilios.png" alt="primeros auxilios">
                                            <img src="img/sliders/botiquin.png" alt="Botiquin">
                                            <img src="img/sliders/enfermo.jpg" alt="Paciente">
                                        ...
                                        <div class="col-8">
                                            <div class="card text-center">
                                                ...
                                                <div class="card-body">
                                                  ...
                                                  <p class="card-text" style="font-size: 18px; text-align: justify;">Brindar herramientas para la atención 
                                                      como primer respondiente en aquellos eventos súbitos que 
                                                  ...
                                                  <p class="card-text" style="font-size: 18px; text-align: justify;">
                                                    Miembros del Copasst de la empresa y público en general.
                                                    </p>
                                                      ...
                                                      <p class="card-text" style="font-size: 18px; text-align: justify;">
                                                        ...
                                                        <p class="card-text" style="font-size: 18px; text-align: justify;">
                                                          ...
                                                          <p class="card-text" style="font-size: 18px; text-align: justify;">
                                                           ...
                                                           <p class="card-text" style="font-size: 18px; text-align: justify;">
                                                             Autodiagnóstico de conocimientos previos. <br>
                                                             Signos vitales (Temperatura, F. Respiratoria, Pulso, estado de conciencia).  <br>
                                                             Manejo de heridas leves y moderadas.<br>
                                                             Obstrucción de vías respiratorias (Maniobra de Heimlich).<br>
                                                             Identificación de signos de alarma. <br>
                                                             Notificación inmediata de eventos.<br>
                                                             Cuidados de primer respondiente a los usuarios accidentados y enfermedad súbita de acuerdo con el evento y normativa vigente.        
                                                          </p>
                                                        ...
                                                        <p class="card-text" style="font-size: 18px; text-align: justify;">
                                                          ...
                                                          <h3 class="card-title" style="text-align: left;">
                                                            * El costo incluye el certificado de asistencia.
                                                            ...
                                                            <h3 class="card-title" style="text-align: left;">
                                                                * El costo no incluye materiales
                                                            </h3>
                                                </div>
