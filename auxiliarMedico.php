...
<html lang="en">
<head>
	<title>.:CORPORACIÓN CENDI AUX MÉDICO:.</title>
	<meta charset="UTF-8">
					...
					<div class="post-item">
                        ...
                        <h5 style="text-align: center;">Lic. de Funcionamiento N° 05293 de Junio 25 de 2009<br>
                                    ...
                                    <div class="col-8">
                                      <div class="tab-content" id="nav-tabContent">
                                        ...
                                        <div class="tab-pane fade" id="plan" role="tabpanel" aria-labelledby="list-profile-list"style="text-align: justify;">
                                            ...
                                            El programa Técnico Laboral como Auxiliar en Secretariado Médico, cuenta con un total de 1.200 horas, 
                                        ...
                                        <div class="tab-pane fade" id="especificos" role="tabpanel" aria-labelledby="list-settings-list"style="text-align: justify;">
                                            ...
                                            <br>
                                                <ul class="about-list">
                                                    ...
                                                    <br>
                                                    <br>
                                                    <i class="fa fa-check-square-o" style="color: red;"></i> Introducción a los servicios de salud y seguridad Social.
                                                    <br>
                                                    <br>
                                                    <i class="fa fa-check-square-o" style="color: red;"></i> Documentación clínica.
                                                    <br>
                                                    <br>
                                                    <i class="fa fa-check-square-o" style="color: red;"></i> Calidad en salud.
                                                    <br>
                                                    <br>
                                                    <i class="fa fa-check-square-o" style="color: red;"></i> Software médico.
                                                    <br>
                                                    <br>
                         ...
                         <h5 style="text-align: center;">
                            ...
                            TÉCNICO LABORAL POR COMPETENCIAS COMO AUXILIAR EN SECRETARIADO MÉDICO <br>
