	...
	<nav class="nav-section">
		<div class="container">
			<div class="nav-right">
				...
				<a href="#" data-toggle="modal" data-target="#login" title="Iniciar sesión administrativos"><i
									...
									<div class="col-4">
										<div class="list-group" id="list-tab" role="tablist">
											<a class="list-group-item list-group-item-action active" id="list-home-list"
												data-toggle="list" href="#generales" role="tab"
												aria-controls="home">GENERALES:</a>
											<a class="list-group-item list-group-item-action " id="list-home-list"
												data-toggle="list" href="#bachiller" role="tab"
												aria-controls="home">BACHILLERATO:</a>
											<a class="list-group-item list-group-item-action" id="list-profile-list"
												data-toggle="list" href="#tecnico" role="tab"
												aria-controls="profile">TÉCNICOS:</a>
										</div>
									</div>
									<div class="col-8">
										<div class="tab-content" id="nav-tabContent">
												...
												<section class="courses-section spad">
													<div class="container">
														<div class="section-title text-center">
															...
															<p>Podrás ahora visualizar los comunicados publicados por la
																institución</p>
																...
																<div class="col-lg-6" style="padding:0.5%;">
																	<div class="card" style="width: 18rem;">
																		<img class="card-img-top"
																			src="img/sliders/comunicados.jpg"
																			alt="Practicas">
																		<div class="card-body">
																			<h5 class="card-title">DOCENTES BACHILLERATO
																				EDUCACIÓN DE ADULTOS – TODAS LAS SEDES
																			</h5>
																			<br>
																			<p class="card-text">Comunicado para
																				bachillerato</p>
																			<p class="card-text">Abril 24 de 2020</p>
																			<BR>
																			<a href="DOCS/comunicados/informacionGeneral.docx"
											...
											<div class="tab-pane fade " id="bachiller" role="tabpanel"
												aria-labelledby="list-home-list" style="text-align: justify;">
												<section class="courses-section spad">
													<div class="container">
														<div class="section-title text-center">
															...
															<div class="row" style="text-align: center;">
																<div class="col-lg-6" style="padding:0.5%;">
																	<div class="card" style="width: 18rem;">
																		...
																		<div class="card-body">
																		  <h5 class="card-title">COMUNICADO A ESTUDIANTES<br></h5>
																			
																		  <p class="card-text">Comunicado para bachillerato</p>
																		  <p class="card-text">Junio 9 de 2020</p>
																		  <br><br><br>
																		  <a href="DOCS/comunicados/COMUNICADO estudiantes 15.docx" class="btn btn-primary"><i class="fa fa-download"></i> DESCARGAR</a>
																		</div>
																	  </div>
																	</div>
																<div class="col-lg-6" style="padding:0.5%;">
																...
																<div class="col-lg-6" style="padding:0.5%;">
																	<div class="card" style="width: 18rem;">
																		<img class="card-img-top"
																			...
																			alt="Practicas">
																		<div class="card-body">
																			<h5 class="card-title">PROGRAMACIÓN TUTORIAS PRESENCIALES </h5>
																			<br><br>
																			<p class="card-text">Comunicado para
																				bachillerato</p>
																			<p class="card-text">Mayo 20 de 2020</p>
																			<br>
																			<a href="DOCS/materialApoyoBachillerato/PROGRAMACION TUTORIAS PRESENCIALES.xlsx"
																				class="btn btn-primary"><i
																					class="fa fa-download"></i>
																				DESCARGAR</a>
																		</div>
																...
																<div class="col-lg-6" style="padding:0.5%;">
																	<div class="card" style="width: 18rem;">
																		<img class="card-img-top"
																			...
																			alt="Practicas">
																		<div class="card-body">
																			<h5 class="card-title">PROGRAMACIÓN AULAS
																				VIRTUALES </h5>
																			<br>
																			<p class="card-text">Comunicado para
																				bachillerato</p>
																			<p class="card-text">Mayo 2 de 2020</p>
																			<br>
																			<a href="DOCS/comunicados/HORARIOS AULAS VIRTUALES.xlsx"
																				class="btn btn-primary"><i
																					class="fa fa-download"></i>
																				DESCARGAR</a>
																		</div>
																...
																<div class="col-lg-6" style="padding:0.5%;">
																	<div class="card" style="width: 18rem;">
																		...
																		<div class="card-body">
																			...
																			<p class="card-text">Comunicado para
																				bachillerato</p>
																			<p class="card-text">Abril 29 de 2020</p>
																			<br>
																			<a href="DOCS/comunicados/horario aulas virtuales 27 abril.xlsx"
																				class="btn btn-primary"><i
																					class="fa fa-download"></i>
																				DESCARGAR</a>
																		</div>
																...
																<div class="col-lg-6" style="padding:0.5%;">
																	<div class="card" style="width: 18rem;">
																		<img class="card-img-top"
																			...
																			alt="Practicas">
																		<div class="card-body">
																			<h5 class="card-title">ESTUDIANTES, PADRES
																				DE FAMILIA O ACUDIENTES DE LA
																				INSTITUCIÓN,
																				TODAS LAS SEDES </h5>
																			<br>
																			<p class="card-text">Comunicado para
																			...
																			<BR>
																			<a href="DOCS/formatos/comunicadoBachillerato.pdf"
																				class="btn btn-primary"><i
																					class="fa fa-download"></i>
																				DESCARGAR</a>
																		</div>
																...
																<div class="col-lg-6" style="padding:0.5%;">
																	<div class="card" style="width: 18rem;">
																		<img class="card-img-top"
																			...
																			alt="alfabetización">
																		<div class="card-body">
																			<h5 class="card-title">ENTREGA DE GUIAS
																				TALLERES EN LAS DIFERENTES SEDES PARA
																				ESTUDIANTES QUE NO TIENEN ACCESO A
																				INTERNET</h5>
																			<p class="card-text">Comunicado para
																				bachillerato</p>
																			<p class="card-text">Abril 18 de 2020</p>
																			<br>
																			<a href="DOCS/comunicados/HORARIOS TALLERES SEDE PRINCIPAL.pdf"
																				class="btn btn-primary"><i
																					class="fa fa-download"></i>
																				DESCARGAR</a>
											...
											<div class="tab-pane fade" id="tecnico" role="tabpanel"
												aria-labelledby="list-profile-list" style="text-align: justify;">
												<section class="courses-section spad">
													<div class="container">
														<div class="section-title text-center">
																...
																<div class="col-lg-6" style="padding:0.5%;">
																	<div class="card" style="width: 18rem;">
																		<img class="card-img-top"
																			...
																			alt="Practicas">
																		<div class="card-body">
																			<h5 class="card-title">COMUNIDAD EDUCATIVA –
																				CENDI
																				PROGRAMAS TÉCNICOS LABORALES
																				Educación para el Trabajo y el
																				Desarrollo Humano </h5>
																			<p class="card-text">Comunicado para
																				bachillerato</p>
																			<p class="card-text">Abril 20 de 2020</p>
																			<BR>
																			<a href="DOCS/formatos/comunicado14.pdf"
																				class="btn btn-primary"><i
																					class="fa fa-download"></i>
																				DESCARGAR</a>
																		</div>
			...
			<div class="row">
				...
				<div class="col-sm-6 col-lg-3 footer-widget">
					...
					<ul class="contact">
						...
						<li>
							<p><i class="fa fa-phone"></i> +57 (4) 239 98 15</p>
						</li>
						<li>
