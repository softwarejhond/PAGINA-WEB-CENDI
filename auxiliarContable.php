                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                        <div class="list-group" id="list-tab" role="tablist">
                                            ...
                                            <a class="list-group-item list-group-item-action" id="list-profile-list"
                                                data-toggle="list" href="#plan" role="tab" aria-controls="profile">PLAN
                                                DE ESTUDIO:</a>
                                            <a class="list-group-item list-group-item-action" id="list-messages-list"
                                                data-toggle="list" href="#duracion" role="tab"
                                                aria-controls="messages">DURACIÓN:</a>
                                        ...
                                        <div class="tab-content" id="nav-tabContent">
                                            <div class="tab-pane fade show active" id="egreso" role="tabpanel"
                                                ...
                                                <ul class="about-list">
                                                    ...
                                                    de banca, seguros y otros servicios financieros.
                                                    <br>
                                                    <br>
                                                    ...
                                                    <br>
                                                    <br>
                                                    <i class="fa fa-check-square-o" style="color: red;"></i> Operador de
                                                    paquetes contables.
                                                    <br>
                                                    <br>
                                                    <i class="fa fa-check-square-o" style="color: red;"></i> Auxiliares
                                            ...
                                            <div class="tab-pane fade" id="duracion" role="tabpanel"
                                                aria-labelledby="list-messages-list" style="text-align: justify;">
