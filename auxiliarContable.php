...
<html lang="en">
<head>
	<title>.:CORPORACIÓN CENDI AUX CONTABLE:.</title>
	<meta charset="UTF-8">
                                    ...
                                    <div class="col-8">
                                      <div class="tab-content" id="nav-tabContent">
                                        <div class="tab-pane fade show active" id="egreso" role="tabpanel" aria-labelledby="list-home-list" style="text-align: justify;">
                                            ...
                                            <br>
                                            <ul class="about-list">
                                                <i class="fa fa-check-square-o" style="color: red;"></i> Cajeros de servicios financieros.
                                                <br>
                                                <br>
                                                <i class="fa fa-check-square-o" style="color: red;"></i> Auxiliares de banca, seguros y otros servicios financieros.
                                                <br>
                                                <br>
                                                <i class="fa fa-check-square-o" style="color: red;"></i> Auxiliar del contador.
                                                <br>
                                                <br>
                                                <i class="fa fa-check-square-o" style="color: red;"></i> Auxiliar de revisoría Fiscal.
                                                <br>
                                                <br>
                                                <i class="fa fa-check-square-o" style="color: red;"></i> Operador de paquetes contables.
                                                <br>
                                                <br>
                                                <i class="fa fa-check-square-o" style="color: red;"></i> Auxiliares de cartera y cobranzas
                                            </ul>
                                        ...
                                        <div class="tab-pane fade" id="plan" role="tabpanel" aria-labelledby="list-profile-list"style="text-align: justify;">
											...
											El programa Técnico laboral como auxiliar contable, cuenta con un total de 1.200 horas, distribuidas en tres niveles de 
											formación: 50% teórico (600 horas) y 50% prácticas (600 horas). Las horas prácticas serán de cumplimiento en las 
                                        ...
                                        <div class="tab-pane fade" id="especificos" role="tabpanel" aria-labelledby="list-settings-list"style="text-align: justify;">
                                            ...
                                            <br>
                                                <ul class="about-list">
                                                    <i class="fa fa-check-square-o" style="color: red;"></i> Legislación comercial.<br>
                                                    <br>
