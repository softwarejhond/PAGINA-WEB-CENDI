...
<body>
			...
			<ul class="main-menu">
				...
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					  ...
					  <a class="dropdown-item active" href="manejoCliente.html">Manejo de clientes con dificultades, quejas y reclamos</a>
					</div>
				  </li>
	...
	<div class="site-breadcrumb">
		<div class="container">
			...
			<span>Taller en: Seminario en manejo de clientes con dificultades, quejas y reclamos.</span>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 post-list">
					<div class="post-item">
                        <h4>Taller en: Seminario en manejo de clientes con dificultades, quejas y reclamos. </h4>
                        <br>
                        <div class="post-thumb set-bg" data-setbg="img/sliders/quejas.png"></div>
                        <br>
                            ...
                            <div class="row">
                                <div class="col-lg-12 about-text">
                                    <div class="row">
                                        <div class="col-4">
                                            <img src="img/sliders/quejas.png" alt="reclamos">
                                        ...
                                        <div class="col-8">
                                            <div class="card text-center">
                                                <div class="card-header">
                                                    Taller en: Seminario en manejo de clientes con dificultades, quejas y reclamos.
                                                </div>
                                                <div class="card-body">
                                                        ...
                                                        <p class="card-text" style="font-size: 18px; text-align: justify;">
                                                          ...
                                                          <p class="card-text" style="font-size: 18px; text-align: justify;">
                                                            ...
                                                            <p class="card-text" style="font-size: 18px; text-align: justify;">
                                                               ...
                                                               * Comunicación asertiva y efectiva, comportamiento pasivo, asertivo y agresivo.<br>
                                                               * Elementos para desarrollar la asertividad.<br>
                                                               * Conozca los 8 pasos para manejar un cliente difícil.<br>
                                                               * Tipos de clientes difíciles y su manejo adecuado.<br>
                                                               * Cualidades del servicio, hábitos para prestar un servicio excelente, elementos básicos del servicio al cliente.<br>
                                                               * Las quejas un gran momento de contacto con el cliente.<br>
                                                               * Instrumento para evaluar el nivel de usos de los recursos disponible en la vida personal (RDVP).<br>
                                                               * Clínicas de servicio, juegos de roles.<br>
