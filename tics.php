...
<body>
	...
	<header class="header-section">
		<div class="container">
			<!-- logo -->
			<a href="index.html" class="site-logo"><img src="img/icons/cendi.png" alt="Logo" width="30%"></a>
			...
			<div class="row">
				<div class="col-lg-12 post-list">
					<div class="post-item">
                        <h4>Tic´s </h4>
                        <br>
                        <div class="post-thumb set-bg" data-setbg="img/sliders/tics.jpg"></div>
                        <br>
                            ...
                            <div class="row">
                                <div class="col-lg-12 about-text">
                                    <div class="row">
                                        <div class="col-4">
                                            <img src="img/sliders/excel.png" alt="Ofimatica">
                                            <img src="img/sliders/amigos.png" alt="Interacción">
                                            ...
                                            <div class="card text-center">
                                                ...
                                                <div class="card-body">
												  ...
												  <p class="card-text" style="font-size: 18px; text-align: justify;">
													Brindar herramientas para la operación de Excel, Word, Bases de datos simples 
													a través de ejercicios prácticos y la aplicación de contenidos relacionados. 
                                                    </p>
                                                    <h3 class="card-title" style="text-align: left;">Dirigido a:</h3>
                                                  <p class="card-text" style="font-size: 18px; text-align: justify;">
                                                    Estudiantes segundo nivel todos los programas (Obligatorio) Público en general.
                                                    </p>
                                                    ...
                                                    <p class="card-text" style="font-size: 18px; text-align: justify;">
                                                      ...
                                                      <p class="card-text" style="font-size: 18px; text-align: justify;">
                                                        ...
                                                        <p class="card-text" style="font-size: 18px; text-align: justify;">
                                                            Mínimo tener conocimiento de un computador.
                                                          </p>
                                                          ...
                                                          <p class="card-text" style="font-size: 18px; text-align: justify;">
                                                           ...
                                                           <p class="card-text" style="font-size: 18px; text-align: justify;">
                                                             ...
                                                             Word.  <br>
                                                             Bases de datos.<br>
															 Operaciones básicas de sistemas.<br>
															</p>
