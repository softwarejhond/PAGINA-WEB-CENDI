		...
		<div class="container">
			...
			<div class="row" style="text-align: center;">
				<div class="col-md-6 col-lg-3">
					<div class="member"><img src="img/icons/celac-adm.png" alt="celac">

					</div>
				</div>
				<div class="col-md-6 col-lg-3">
					<div class="member">
						<div class="member"><img src="img/icons/logo-sena.png" alt="sena">
				...
				<div class="col-md-6 col-lg-3">
					<div class="member">
						<div class="member"><img src="img/icons/Min.png" alt="min">
				...
				<div class="col-md-6 col-lg-3">
					<div class="member">
						<div class="member"><img src="img/icons/Secedu.png" alt="secedu">
				...
				<div class="col-md-6 col-lg-3">
					<div class="member">
						<div class="member"><img src="img/icons/Q10.png" alt="q10">
				...
				<div class="col-md-6 col-lg-3">
					<div class="member">
						<div class="member"><img src="img/icons/Mega.png" alt="mega" width="100%">
				...
				<div class="col-md-6 col-lg-3">
					<div class="member">
						<div class="member"><img src="img/icons/mejores.png" alt="mejores">
				...
				<div class="col-md-6 col-lg-3">
					<div class="member">
						<div class="member"><img src="img/icons/lineaVital.png" alt="Droguería Linea Vital">
	...
	<div class="text-center">
		<div class="modal fade bd-example-modal-lg" id="info" tabindex="-1" role="dialog"
			...
			<div class="modal-dialog modal-lg" style="text-align: center; max-width: 1140px;">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-exclamation"></i> Matrículas abiertas
							<i class="fa fa-exclamation"></i> </h5>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"
							title="Cerrar"></button>
						<span aria-hidden="true">&times;</span>
						</button>
					...
					<div class="modal-body lg">
						<div class="container">
							<div class="row">
								<div class="col-lg-12">
										<img
											src="img/modals/cursos.jpg" alt="cursos"
											width="50%" class="miniature">
											
									<br>
									<br>
									<a href="https://inscripciones.medellindigital.gov.co/convocatorias/formulario.php?token=01YpblQcTS.OQ" class="btn btn-success" target="_blank">REGÍSTRATE AHORA</a>
									<br>
									<br>
								</div>
